...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    ErrorMsg                               { fg="#ffaaff", bg="#880066", }, -- ErrorMsg       xxx ctermfg=15 ctermbg=1 guifg=White guibg=Red
    ...
    WarningMsg                             { fg="#880066", }, -- WarningMsg     xxx ctermfg=224 guifg=Red
    ...
    FoldColumn                             { fg="cyan", bg="#551155", }, -- FoldColumn     xxx ctermfg=14 ctermbg=242 guifg=Cyan guibg=Grey
    ...
    DiffText                               { bg="#880066", gui="bold", }, -- DiffText       xxx cterm=bold ctermbg=9 gui=bold guibg=Red
    SignColumn                             { fg="cyan", bg="#551155", }, -- SignColumn     xxx ctermfg=14 ctermbg=242 guifg=Cyan guibg=Grey
    CursorLineSign                         { SignColumn }, -- CursorLineSign xxx links to SignColumn
    Conceal                                { fg="#551155", bg="#410048", }, -- Conceal        xxx ctermfg=7 ctermbg=242 guifg=LightGrey guibg=DarkGrey
    SpellBad                               { gui="undercurl", sp="#880066", }, -- SpellBad       xxx ctermbg=9 gui=undercurl guisp=Red
    ...
    Pmenu                                  { bg="#550044", }, -- Pmenu          xxx ctermfg=0 ctermbg=13 guibg=Magenta
    ...
    PmenuSel                               { bg="#410048", }, -- PmenuSel       xxx ctermfg=242 ctermbg=0 guibg=DarkGrey
    PmenuKindSel                           { PmenuSel }, -- PmenuKindSel   xxx links to PmenuSel
    PmenuExtraSel                          { PmenuSel }, -- PmenuExtraSel  xxx links to PmenuSel
    PmenuSbar                              { bg="#551155", }, -- PmenuSbar      xxx ctermbg=248 guibg=Grey
    PmenuThumb                             { bg="white", }, -- PmenuThumb     xxx ctermbg=15 guibg=White
    TabLine                                { bg="#551155", gui="underline", }, -- TabLine        xxx cterm=underline ctermfg=15 ctermbg=242 gui=underline guibg=DarkGrey
    ...
    ColorColumn                            { bg="#480026", }, -- ColorColumn    xxx ctermbg=1 guibg=DarkRed
    ...
    Normal                                 { fg="#730099", bg="#180020", }, -- Normal         xxx guifg=#730099 guibg=#1a0016
    ...
    RedrawDebugRecompose                   { bg="#880066", }, -- RedrawDebugRecompose xxx ctermbg=9 guibg=Red
    Error                                  { fg="white", bg="#880066", }, -- Error          xxx ctermfg=15 ctermbg=9 guifg=White guibg=Red
    ...
    Constant                               { fg="#8f2080", }, -- Constant       xxx ctermfg=13 guifg=#ffa0a0
    ...
    PreProc                                { fg="#af60cf", }, -- PreProc        xxx ctermfg=81 guifg=#ff80ff
    ...
    Special                                { fg="#800fa0", }, -- Special        xxx ctermfg=224 guifg=Orange
    ...
    DiagnosticError                        { fg="#af0080", }, -- DiagnosticError xxx ctermfg=1 guifg=Red
    ...
    DiagnosticInfo                         { fg="#af6080", }, -- DiagnosticInfo xxx ctermfg=4 guifg=LightBlue
    ...
    DiagnosticHint                         { fg="#af309f", }, -- DiagnosticHint xxx ctermfg=7 guifg=LightGrey
    ...
    DiagnosticOk                           { fg="#af60af", }, -- DiagnosticOk   xxx ctermfg=10 guifg=LightGreen
    ...
    DiagnosticUnderlineError               { gui="underline", sp="#880066", }, -- DiagnosticUnderlineError xxx cterm=underline gui=underline guisp=Red
    ...
    DiagnosticUnderlineHint                { gui="underline", sp="#551155", }, -- DiagnosticUnderlineHint xxx cterm=underline gui=underline guisp=LightGrey
    ...
    DiagnosticDeprecated                   { gui="strikethrough", sp="#880066", }, -- DiagnosticDeprecated xxx cterm=strikethrough gui=strikethrough guisp=Red
    ...
    NvimInternalError                      { fg="#880066", bg="#880066", }, -- NvimInternalError xxx ctermfg=9 ctermbg=9 guifg=Red guibg=Red
